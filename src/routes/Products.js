...
router.get("/search/by-name/:keyword", productController.getProductListByKeyword);
router.get("/search/by-id/:productId", productController.getProductById);
router.get("/search/by-number/:productNumber", productController.getProductByNumber);
